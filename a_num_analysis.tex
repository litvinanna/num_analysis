...
\newcommand\bigzero{\makebox(0,0){\text{\huge0}}} %для простановки выровненных больших 0 в матрице -- например в 6.27
\newcommand{\rvline}{\hspace*{-\arraycolsep}\vline\hspace*{-\arraycolsep}} %нормальное выравнивание вертикальной линии в 6.28
